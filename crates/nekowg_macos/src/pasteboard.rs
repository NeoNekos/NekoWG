...
use crate::ns_string;
use nekowg::{ClipboardEntry, ClipboardItem, ClipboardString, Image, ImageFormat, hash};
        ...
        unsafe {
            match item.entries.as_slice() {
                ...
                _ => {
                    ...
                    // https://github.com/zed-industries/zed/blob/65f7412a0265552b06ce122655369d6cc7381dd6/crates/nekowg/src/platform/mac/platform.rs#L1060-L1110
                    //
...
mod tests {
    ...
    use nekowg::{ClipboardEntry, ClipboardItem, ClipboardString};
