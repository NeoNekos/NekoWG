...
impl CosmicTextSystemState {
    ...
    fn load_family(
        ...
        let name = nekowg::font_name_with_fallbacks(name, &self.system_font_fallback);
...
fn find_best_match(
    ...
    let target_italic = matches!(
        font.style,
        nekowg::FontStyle::Italic | nekowg::FontStyle::Oblique
    );
...
#[cfg(feature = "font-kit")]
fn font_into_properties(font: &nekowg::Font) -> font_kit::properties::Properties {
    font_kit::properties::Properties {
        style: match font.style {
            nekowg::FontStyle::Normal => font_kit::properties::Style::Normal,
            nekowg::FontStyle::Italic => font_kit::properties::Style::Italic,
            nekowg::FontStyle::Oblique => font_kit::properties::Style::Oblique,
        },
