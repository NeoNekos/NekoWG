...
impl TestScheduler {
    ...
    /// This is used by NekoWG's TestDispatcher to map dispatcher instances to sessions.
    ...
    ///
    /// This is the public interface for NekoWG's TestDispatcher to drive task execution.
