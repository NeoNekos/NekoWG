...
pub fn visibility_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn visible(mut self) -> Self {
            self.style().visibility = Some(nekowg::Visibility::Visible);
            self
        }
        ...
        #visibility fn invisible(mut self) -> Self {
            self.style().visibility = Some(nekowg::Visibility::Hidden);
            self
        }
    };
...
pub fn position_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn relative(mut self) -> Self {
            self.style().position = Some(nekowg::Position::Relative);
            self
        }
        ...
        #visibility fn absolute(mut self) -> Self {
            self.style().position = Some(nekowg::Position::Absolute);
            self
        }
...
pub fn overflow_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn overflow_hidden(mut self) -> Self {
            self.style().overflow.x = Some(nekowg::Overflow::Hidden);
            self.style().overflow.y = Some(nekowg::Overflow::Hidden);
            self
        }
...
pub fn cursor_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn cursor_default(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::Arrow);
            self
        }
        ...
        #visibility fn cursor_pointer(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::PointingHand);
            self
        }
        ...
        #visibility fn cursor_text(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::IBeam);
            self
        }
        ...
        #visibility fn cursor_move(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ClosedHand);
            self
        }
        ...
        #visibility fn cursor_not_allowed(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::OperationNotAllowed);
            self
        }
        ...
        #visibility fn cursor_context_menu(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ContextualMenu);
            self
        }
        ...
        #visibility fn cursor_crosshair(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::Crosshair);
            self
        }
        ...
        #visibility fn cursor_vertical_text(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::IBeamCursorForVerticalLayout);
            self
        }
        ...
        #visibility fn cursor_alias(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::DragLink);
            self
        }
        ...
        #visibility fn cursor_copy(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::DragCopy);
            self
        }
        ...
        #visibility fn cursor_grab(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::OpenHand);
            self
        }
        ...
        #visibility fn cursor_ew_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeLeftRight);
            self
        }
        ...
        #visibility fn cursor_ns_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeUpDown);
            self
        }
        ...
        #visibility fn cursor_nesw_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeUpRightDownLeft);
            self
        }
        ...
        #visibility fn cursor_nwse_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeUpLeftDownRight);
            self
        }
        ...
        #visibility fn cursor_col_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeColumn);
            self
        }
        ...
        #visibility fn cursor_row_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeRow);
            self
        }
        ...
        #visibility fn cursor_n_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeUp);
            self
        }
        ...
        #visibility fn cursor_e_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeRight);
            self
        }
        ...
        #visibility fn cursor_s_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeDown);
            self
        }
        ...
        #visibility fn cursor_w_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::ResizeLeft);
            self
        }
        ...
        #visibility fn cursor_none(mut self, cursor: CursorStyle) -> Self {
            self.style().mouse_cursor = Some(nekowg::CursorStyle::None);
            self
        }
    };
...
pub fn box_shadow_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn shadow(mut self, shadows: std::vec::Vec<nekowg::BoxShadow>) -> Self {
        ...
        #visibility fn shadow_2xs(mut self) -> Self {
            use nekowg::{BoxShadow, hsla, point, px};
            use std::vec;
...
fn generate_predefined_setter(
    ...
    let field_assignments = fields
        ...
        .map(|field_tokens| {
            quote! {
                style.#field_tokens = Some((#negation_token nekowg::#length_tokens).into());
            }
        })
        .collect::<Vec<_>>();
...
fn generate_custom_value_setter(
    ...
    let method = quote! {
        #[doc = #doc_string]
        #visibility fn #method_name(mut self, length: impl std::clone::Clone + Into<nekowg::#length_type>) -> Self {
            let style = self.style();
            #(#field_assignments)*
            self
        }
