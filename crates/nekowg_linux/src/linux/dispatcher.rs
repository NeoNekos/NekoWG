...
impl PlatformDispatcher for LinuxDispatcher {
    fn get_all_timings(&self) -> Vec<nekowg::ThreadTaskTimings> {
        let global_timings = GLOBAL_THREAD_TIMINGS.lock();
        ThreadTaskTimings::convert(&global_timings)
    }

    fn get_current_thread_timings(&self) -> nekowg::ThreadTaskTimings {
...
impl<T> PriorityQueueCalloopSender<T> {
    ...
    fn send(&self, priority: Priority, item: T) -> Result<(), nekowg::queue::SendError<T>> {
...
// [crates/nekowg/src/platform/linux/dispatcher.rs:262:9]
// returning 1 tasks to process
// [crates/nekowg/src/platform/linux/dispatcher.rs:480:75] evt = Msg(
//     (),
// )
// returning 0 tasks to process

// thread 'linux::dispatcher::tests::tomato' (478301) panicked at crates/nekowg/src/platform/linux/dispatcher.rs:515:9:
