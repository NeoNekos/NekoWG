    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
                ...
                div()
                    ...
                    .child(
                        div().flex_1().rounded_xl().bg(linear_gradient(
                            135.,
                            linear_color_stop(nekowg::red(), 0.),
                            linear_color_stop(nekowg::green(), 1.),
                        )
                        .color_space(color_space)),
                    )
                    .child(
                        div().flex_1().rounded_xl().bg(linear_gradient(
                            225.,
                            linear_color_stop(nekowg::green(), 0.),
                            linear_color_stop(nekowg::blue(), 1.),
                        )
                        .color_space(color_space)),
                    )
                    .child(
                        div().flex_1().rounded_xl().bg(linear_gradient(
                            315.,
                            linear_color_stop(nekowg::green(), 0.),
                            linear_color_stop(nekowg::yellow(), 1.),
                        )
                        .color_space(color_space)),
                    ),
            )
                ...
                div()
                    ...
                    .child(
                        div().flex_1().rounded_xl().bg(linear_gradient(
                            0.,
                            linear_color_stop(nekowg::red(), 0.),
                            linear_color_stop(nekowg::white(), 1.),
                        )
                        .color_space(color_space)),
                    )
                    .child(
                        div().flex_1().rounded_xl().bg(linear_gradient(
                            90.,
                            linear_color_stop(nekowg::blue(), 0.),
                            linear_color_stop(nekowg::white(), 1.),
                        )
                        .color_space(color_space)),
                    )
                    ...
                    .child(
                        div().flex_1().rounded_xl().bg(linear_gradient(
                            360.,
                            linear_color_stop(nekowg::yellow(), 0.),
                            linear_color_stop(nekowg::white(), 1.),
                        )
                        .color_space(color_space)),
                    ),
            ...
            .child(
                div().flex_1().rounded_xl().bg(linear_gradient(
                    0.,
                    linear_color_stop(nekowg::green(), 0.05),
                    linear_color_stop(nekowg::yellow(), 0.95),
                )
                .color_space(color_space)),
            )
            .child(
                div().flex_1().rounded_xl().bg(linear_gradient(
                    90.,
                    linear_color_stop(nekowg::blue(), 0.05),
                    linear_color_stop(nekowg::red(), 0.95),
                )
                .color_space(color_space)),
            )
            .child(
                div()
                    ...
                    .child(
                        div().flex().flex_1().gap_3().child(
                            div().flex_1().rounded_xl().bg(linear_gradient(
                                90.,
                                linear_color_stop(nekowg::blue(), 0.5),
                                linear_color_stop(nekowg::red(), 0.5),
                            )
                            .color_space(color_space)),
                        ),
                    )
            ...
            .child(div().h_24().child(canvas(
                ...
                move |bounds, _, window, _| {
                    ...
                    let mut builder = nekowg::PathBuilder::fill();
