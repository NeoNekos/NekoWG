...
//!
//! ```no_run
//! # use nekowg::{App, AppContext, Application, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
//! nekowg_platform::application().run(|cx: &mut App| {
...
//!
//! ```no_run
//! # use nekowg::{App, AppContext, Application, Context, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
//! nekowg_platform::application().run(|cx: &mut App| {
...
//!
//! ```no_run
//!  # use nekowg::{App, AppContext, Application, Entity, prelude::*};
//!  # struct Counter {
//!  #     count: usize,
//!  # }
//!  nekowg_platform::application().run(|cx: &mut App| {
...
//!
//! In addition to `observe` and `notify`, which indicate that an entity's state has changed, NekoWG also offers `subscribe` and `emit`, which enables entities to emit typed events. To opt into this system, the emitting object must implement the `EventEmitter` trait.
//!
//! Let's introduce a new event type called `CounterChangeEvent`, then indicate that `Counter` can emit this type of event:
//!
//! ```no_run
//! use nekowg::EventEmitter;
//! # struct Counter {
//! #     count: usize,
//! # }
...
//!
//! ```no_run
//! # use nekowg::{App, AppContext, Application, Context, Entity, EventEmitter};
//! # struct Counter {
//! #     count: usize,
//! # }
//! # struct CounterChangeEvent {
