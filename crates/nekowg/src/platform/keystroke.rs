...
pub trait AsKeystroke {
    /// Returns the NekoWG representation of the keystroke.
...
pub struct KeybindingKeystroke {
    /// The NekoWG representation of the keystroke.
    inner: Keystroke,
...
impl KeybindingKeystroke {
    ...
    /// - On macOS and Linux, this modifiers is the same as `inner.modifiers`, which is the NekoWG representation of the keystroke.
    ...
    ///
    /// Platform-specific behavior:
    /// - On macOS and Linux, this key is the same as `inner.key`, which is the NekoWG representation of the keystroke.
