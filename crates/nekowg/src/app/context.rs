...
impl<'a, T: 'static> Context<'a, T> {
    ...
    /// Register a callback to be invoked when NekoWG releases this entity.
    ...
    /// Tell NekoWG that this entity has changed and observers of it should be notified.
    ...
    ///
    /// Many NekoWG callbacks take the form of `Fn(&E, &mut Window, &mut App)`,
...
impl<T> AppContext for Context<'_, T> {
    ...
    #[inline]
    fn as_mut<'a, E>(&'a mut self, handle: &Entity<E>) -> super::NekowgBorrow<'a, E>
    where
        E: 'static,
    {
