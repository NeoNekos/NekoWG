//! KeyDispatch is where NekoWG deals with binding actions to key events.
//!
...
//! ```
//!
//! With all of this in place, NekoWG will ensure that if you have an Editor that contains
...
//!
//! In NekoWG, keybindings are not limited to just single keystrokes, you can define
...
mod tests {
    use crate::{
        self as nekowg, AppContext, DispatchResult, Element, ElementId, GlobalElementId,
