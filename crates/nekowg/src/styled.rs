use crate::{
    self as nekowg, AbsoluteLength, AlignContent, AlignItems, BorderStyle, CursorStyle,
...
#[cfg_attr(
    ...
    nekowg_macros::derive_inspector_reflection
)]
pub trait Styled: Sized {
    /// Returns a reference to the style memory of this element.
    fn style(&mut self) -> &mut StyleRefinement;

    nekowg_macros::style_helpers!();
    nekowg_macros::visibility_style_methods!();
    nekowg_macros::margin_style_methods!();
    nekowg_macros::padding_style_methods!();
    nekowg_macros::position_style_methods!();
    nekowg_macros::overflow_style_methods!();
    nekowg_macros::cursor_style_methods!();
    nekowg_macros::border_style_methods!();
    nekowg_macros::box_shadow_style_methods!();
