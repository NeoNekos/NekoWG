//! Elements are the workhorses of NekoWG. They are responsible for laying out and painting all of
...
//! own APIs and NekoWG, or other element implementation, uses the APIs in this module to convert
...
//! tree and any callbacks they have registered with NekoWG are dropped and the process repeats.
//!
//! But some state is too simple and voluminous to store in every view that needs it, e.g.
//! whether a hover has been started or not. For this, NekoWG provides the [`Element::PrepaintState`], associated type.
//!
//! # Implementing your own elements
//!
//! Elements are intended to be the low level, imperative API to NekoWG. They are responsible for upholding,
//! or breaking, NekoWG's features as they deem necessary. As an example, most NekoWG elements are expected
...
//!
//! However, most of the time, you won't need to implement your own elements. NekoWG provides a number of
