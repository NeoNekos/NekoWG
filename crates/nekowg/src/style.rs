...
pub struct Style {
    ...
    /// to the X axis.
    ///
    /// Currently, NekoWG operates differently from the web in that it will scroll an element in either the X or Y axis
...
/// The properties that can be used to style text in NekoWG
