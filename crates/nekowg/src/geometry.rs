//! The NekoWG geometry module is a collection of types and traits that
...
impl Point<Pixels> {
    ...
    ///
    /// ```
    /// # use nekowg::{Point, Pixels, ScaledPixels};
...
impl Size<Pixels> {
    ...
    ///
    /// ```
    /// # use nekowg::{Size, Pixels, ScaledPixels};
    ...
    T: Add<T, Output = T> + Clone + Debug + Default + PartialEq,
{
    ...
    ///
    /// ```
    /// use nekowg::{Bounds, Corner, Point, Size};
    /// let bounds = Bounds {
    ///     origin: Point { x: 0, y: 0 },
    ///     size: Size { width: 10, height: 20 },
    /// };
...
impl Bounds<Pixels> {
    ...
    ///
    /// ```
    /// # use nekowg::{Bounds, Point, Size, Pixels, ScaledPixels, DevicePixels};
    /// let bounds = Bounds {
...
impl Edges<Length> {
    ...
    ///
    /// ```
    /// # use nekowg::{DefiniteLength, Edges, Length, Pixels};
...
impl Edges<DefiniteLength> {
    ...
    ///
    /// ```
    /// # use nekowg::{px, DefiniteLength, Edges};
    ...
    ///
    /// ```
    /// # use nekowg::{Edges, DefiniteLength, px, AbsoluteLength, rems, Size};
    /// let edges = Edges {
...
impl Edges<AbsoluteLength> {
    ...
    ///
    /// ```
    /// # use nekowg::{AbsoluteLength, Edges, Pixels};
    ...
    ///
    /// ```
    /// # use nekowg::{Edges, AbsoluteLength, Pixels, px, rems};
    /// let edges = Edges {
...
impl Edges<Pixels> {
    ...
    ///
    /// ```
    /// # use nekowg::{Edges, Pixels, ScaledPixels};
    /// let edges = Edges {
...
impl Corners<AbsoluteLength> {
    ...
    ///
    /// ```
    /// # use nekowg::{Corners, AbsoluteLength, Pixels, Rems, Size};
    /// let corners = Corners {
...
impl Corners<Pixels> {
    ...
    ///
    /// ```
    /// # use nekowg::{Corners, Pixels, ScaledPixels};
    /// let corners = Corners {
...
impl<T: Clone + Debug + Default + PartialEq> Corners<T> {
    ...
    ///
    /// ```
    /// # use nekowg::{Corners, Pixels, Rems};
    /// let corners = Corners {
    ///     top_left: Pixels::from(10.0),
    ///     top_right: Pixels::from(20.0),
    ///     bottom_right: Pixels::from(30.0),
...
///
/// ```
/// use nekowg::{Pixels, ScaledPixels};
///
...
impl AbsoluteLength {
    ...
    ///
    /// ```
    /// # use nekowg::{AbsoluteLength, Pixels, Rems};
...
impl DefiniteLength {
    ...
    ///
    /// ```
    /// # use nekowg::{DefiniteLength, AbsoluteLength, Pixels, px, rems};
