//! Div is the central, reusable element that most NekoWG trees will be built from.
...
//! element, but for NekoWG.
//!
//! # Build your own div
//!
//! NekoWG does not directly provide APIs for stateful, multi step events like `click`
//! and `drag`. We want NekoWG users to be able to build their own abstractions for
...
/// A trait for elements that want to use the standard NekoWG event handlers that don't
/// require any state.
...
/// A trait for elements that want to use the standard NekoWG interactivity features
/// that require state.
...
/// A [`Div`] element, the all-in-one element for building complex UIs in NekoWG
pub struct Div {
