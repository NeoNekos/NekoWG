...
macro_rules! actions {
    ($namespace:path, [ $( $(#[$attr:meta])* $name:ident),* $(,)? ]) => {
        $(
            #[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug, nekowg::Action)]
...
///
/// ```
/// use nekowg::{SharedString, register_action};
/// #[derive(Clone, PartialEq, Eq, serde::Deserialize, schemars::JsonSchema)]
/// pub struct Paste {
///     pub content: SharedString,
/// }
///
/// impl nekowg::Action for Paste {
///     # fn boxed_clone(&self) -> Box<dyn nekowg::Action> { unimplemented!()}
///     # fn partial_eq(&self, other: &dyn nekowg::Action) -> bool { unimplemented!() }
///     # fn name(&self) -> &'static str { "Paste" }
///     # fn name_for_type() -> &'static str { "Paste" }
///     # fn build(value: serde_json::Value) -> anyhow::Result<Box<dyn nekowg::Action>> {
///     #     unimplemented!()
///     # }
/// }
///
...
mod no_action {
    ...
    pub fn is_no_action(action: &dyn nekowg::Action) -> bool {
