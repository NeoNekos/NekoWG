...
#![warn(missing_docs)]
#![allow(clippy::type_complexity)] // Not useful, NekoWG makes heavy use of callbacks
#![allow(clippy::collapsible_else_if)] // False positives in platform specific code
#![allow(unused_mut)] // False positives in platform specific code

extern crate self as nekowg;
#[doc(hidden)]
pub static NEKOWG_MANIFEST_DIR: &'static str = env!("CARGO_MANIFEST_DIR");
#[macro_use]
mod action;
mod app;
...
mod bounds_tree;
mod color;
/// The default colors used by NekoWG.
pub mod colors;
mod element;
mod elements;
mod executor;
...
/// Do not touch, here be dragons for use by nekowg_macros and such.
#[doc(hidden)]
pub mod private {
    pub use anyhow;
    pub use inventory;
...
mod seal {
    /// A mechanism for restricting implementations of a trait to only those in NekoWG.
...
/// This trait is used for the different visual contexts in NekoWG that
...
/// A trait for tying together the types of a NekoWG entity and the events it can
/// emit.
...
/// Information about the GPU NekoWG is running on.
