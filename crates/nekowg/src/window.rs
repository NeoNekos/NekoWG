...
use nekowg_util::{ResultExt, measure};
...
impl Window {
    ...
    /// NekoWG itself automatically in order to pass your element its `Bounds` automatically.
    ///
        ...
        T: Clone + Into<PromptButton>,
    {
        ...
        let Some(prompt_builder) = prompt_builder else {
            unreachable!("Re-entrant window prompting is not supported by NekoWG");
        };
