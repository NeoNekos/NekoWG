...
pub(crate) const WM_NEKOWG_CURSOR_STYLE_CHANGED: u32 = WM_USER + 1;
pub(crate) const WM_NEKOWG_CLOSE_ONE_WINDOW: u32 = WM_USER + 2;
pub(crate) const WM_NEKOWG_TASK_DISPATCHED_ON_MAIN_THREAD: u32 = WM_USER + 3;
pub(crate) const WM_NEKOWG_DOCK_MENU_ACTION: u32 = WM_USER + 4;
pub(crate) const WM_NEKOWG_FORCE_UPDATE_WINDOW: u32 = WM_USER + 5;
pub(crate) const WM_NEKOWG_KEYBOARD_LAYOUT_CHANGED: u32 = WM_USER + 6;
pub(crate) const WM_NEKOWG_GPU_DEVICE_LOST: u32 = WM_USER + 7;
pub(crate) const WM_NEKOWG_KEYDOWN: u32 = WM_USER + 8;
...
impl WindowsWindowInner {
    pub(crate) fn handle_msg(
        ...
        let handled = match msg {
            ...
            WM_NEKOWG_KEYDOWN => self.handle_keydown_msg(wparam, lparam),
            ...
            WM_NEKOWG_CURSOR_STYLE_CHANGED => self.handle_cursor_changed(lparam),
            WM_NEKOWG_FORCE_UPDATE_WINDOW => self.draw_window(handle, true),
    ...
    fn draw_window(&self, handle: HWND, force_render: bool) -> Option<isize> {
        ...
        // we are instructing nekowg to force render a frame, this will
